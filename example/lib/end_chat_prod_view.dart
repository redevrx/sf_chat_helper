...
class EndChatProdView extends StatefulWidget {
  const EndChatProdView({super.key});

  @override
  State<EndChatProdView> createState() => _EndChatProdViewState();
}

class _EndChatProdViewState extends State<EndChatProdView> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    chatHelper = SalesforceChatHelper.builder()
        ...
        // )
        .setProdApexEndpoint("https://bitkubexchange.my.salesforce-sites.com/publicapi/services/apexrest/update-session")
